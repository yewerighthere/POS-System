...
{
    Task<SyncResultDto> SyncCatalogAsync(); Task<SyncResultDto> SyncStockAsync(); Task SendStockDeductionAsync(IEnumerable<OrderItemDto> items, Guid orderId); Task RestockAsync(RestockEventDto dto);
}
