...
{
    Task<PromotionValidationResultDto> ValidateCodeAsync(string code, CartSummaryDto cart); Task<bool> RequestApprovalAsync(Guid promotionId, Guid managerId); Task<CartSummaryDto> ApplyPromotionAsync(string code, CartSummaryDto cart);
}
