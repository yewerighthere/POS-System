...
{
    Task<ShiftDto> OpenShiftAsync(OpenShiftDto dto); Task<ShiftDto> CloseShiftAsync(CloseShiftDto dto); Task<ShiftDto?> GetOpenShiftAsync(Guid userId); Task<ShiftSummaryDto> GetShiftSummaryAsync(Guid shiftId);
}
