...
{
    Task<LoginResponseDto> LoginAsync(LoginRequestDto dto); Task LogoutAsync(Guid sessionId); Task<UserSessionDto?> ValidateTokenAsync(string token); Task CreateDemoUserIfNeededAsync();
}
