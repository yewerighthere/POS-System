...
public class InventorySyncService : IInventorySyncService
{
    ...
    public InventorySyncService(HttpClient httpClient, ILogger<InventorySyncService> logger)
    {
        _httpClient = httpClient;
        _logger = logger;
    }

    public Task<SyncResultDto> SyncCatalogAsync()
    {
    ...
    public Task SendStockDeductionAsync(IEnumerable<OrderItemDto> items, Guid orderId)
    {
        throw new NotImplementedException();
    }

    public Task RestockAsync(RestockEventDto dto)
    {
        throw new NotImplementedException();
    }
}
